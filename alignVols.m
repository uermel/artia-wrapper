...
%   UE, 2020
    ...
    fprintf(scr, ['from chimerax.core.commands import run\n' ...
                  'run(session, "open %s")\n'...
                  'run(session, "open %s")\n'...
                  'run(session, "volume #1 style surface step 1 sdLevel 3 originIndex %d,%d,%d")\n'...
                  'run(session, "volume #2 style surface step 1 sdLevel 3 originIndex %d,%d,%d")\n'...
                  'run(session, "fitmap #2 inMap #1 envelope true search 400 placement sr radius 5 levelInside 0.1")\n' ...
